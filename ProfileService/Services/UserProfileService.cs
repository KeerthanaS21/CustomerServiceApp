    ...
    public class UserProfileService : IUserProfileService
    {
        ...
        public async Task<BaseResponse<string>> AddUserProfile(UserProfileModel profileData)
        {
            ...
            if (profileExists)
            {
                ...
                profileDetails.Dob = profileData.Dob;
        ...
        public async Task<BaseResponse<List<ContactModel>>> ContactDetails()
        {
            var customers = _dbContext.AspNetUsers.Where(x => x.UserRole == 1).Select(x => x.UserName).ToList();
        ...
        public async Task<BaseResponse<List<ProfileModel>>> ProfileDetails()
        {
            var customers = _dbContext.AspNetUsers.Where(x => x.UserRole == 1).Select(x => x.Id).ToList();
