        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactPreference = table.Column<string>(type: "VARCHAR(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contact_AspNetUsers_UserRefId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdValue = table.Column<string>(type: "VARCHAR(50)", maxLength: 50, nullable: false),
                    UserRefId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Profile_AspNetUsers_UserRefId",
                        column: x => x.UserRefId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestDetail = table.Column<string>(type: "VARCHAR(500)", maxLength: 500, nullable: false),
                    RequestStatus = table.Column<string>(type: "VARCHAR(20)", maxLength: 20, nullable: false),
                    RequestAssignedTo = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    RequestAssigneeComments = table.Column<string>(type: "VARCHAR(200)", maxLength: 200, nullable: true),
                    RequestCreatedBy = table.Column<string>(type: "VARCHAR(20)", maxLength: 20, nullable: false),
                    RequestCreatedDate = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    RequestClosedDate = table.Column<DateTime>(type: "DATETIME", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceRequest", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_ServiceRequest_AspNetUsers_RequestAssignedTo",
                        column: x => x.RequestAssignedTo,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Profile_UserRefId",
                table: "Profile",
                column: "UserRefId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequest_RequestAssignedTo",
                table: "ServiceRequest",
                column: "RequestAssignedTo");
        }
